  ...
  (function () {
    ...
    Colibri = function (element, options) {
      ...
      this.opts = $.extend(
        ...
        {},
        this.defaults,
        $.fn[lib_prefix + this.namespace].options,
        elementData,
        instanceData,
        options
      );
      this.$target =
        typeof this.opts.target === "string" ? $(this.opts.target) : null;
    };
    ...
    Colibri.prototype = {
      updateOpts: function (updatedData) {
        ...
        var instanceData = $.extend(
          true,
          {},
          this.defaults,
          Colibri.getData(instanceId)
        );
      ...
      callback: function (type) {
        ...
        if (
          this.opts &&
          this.opts.callbacks &&
          $.isFunction(this.opts.callbacks[type])
        ) {
  ...
  (function (Colibri) {
    Colibri.Plugin = {
      ...
      startAutoloadOnce: function () {
        var self = this;
        var $nodes = $("[data-colibri-component]")
          .not("[data-loaded]")
          .not("[data-disabled]");
        $nodes.each(function () {
          var $el = $(this);
  ...
  (function ($) {
    ...
    $.fn[animationName] = function (effect, callback) {
      ...
      return this.each(function () {
        ...
        $this.data(
          name,
          (data = new Colibri.Animation(this, effect, callback))
        );
      });
    };
